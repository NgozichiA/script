...
#how to execute the script ./sample.sh hostname, ./sample.sh -n hostname, ./sample.sh -v uptime, ./sample.sh -sv id, ./sample.sh -ns id, ./sample.sh -f hostname, ./smaple.sh /path/to/where
